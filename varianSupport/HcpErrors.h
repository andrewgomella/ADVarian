...
HCP_ERROR_TEMPERATURE_1_HIGH_DIGITALBOARD_COMPONENTS,	// 135
HCP_ERROR_TEMPERATURE_2_HIGH_DIGITALBOARD_GLASS,		// 136
HCP_ERROR_TEMPERATURE_3_HIGH_DIGITALBOARD_COMPONENTS,	// 137
HCP_ERROR_TEMPERATURE_4_HIGH_SNAPONBOARD_COMPONENTS,	// 138
HCP_ERROR_TEMPERATURE_5_HIGH_SNAPONBOARD_COMPONENTS,	// 139
HCP_ERROR_TEMPERATURE_6_HIGH_SNAPONBOARD_COMPONENTS,	// 140
HCP_ERROR_TEMPERATURE_7_HIGH,							// 141
HCP_ERROR_TEMPERATURE_8_HIGH,							// 142

HCP_ERROR_VOLTAGE_1_LOW,								// 143
HCP_ERROR_VOLTAGE_2_LOW,								// 144
HCP_ERROR_VOLTAGE_3_LOW,								// 145
HCP_ERROR_VOLTAGE_4_LOW,								// 146
HCP_ERROR_VOLTAGE_5_LOW,								// 147
HCP_ERROR_VOLTAGE_6_LOW,								// 148
HCP_ERROR_VOLTAGE_7_LOW,								// 149
HCP_ERROR_VOLTAGE_8_LOW,								// 150
HCP_ERROR_VOLTAGE_9_LOW,								// 151
HCP_ERROR_VOLTAGE_A_LOW,								// 152
HCP_ERROR_VOLTAGE_B_LOW,								// 153
HCP_ERROR_VOLTAGE_C_LOW,								// 154
HCP_ERROR_VOLTAGE_D_LOW,								// 155
HCP_ERROR_VOLTAGE_E_LOW,								// 156
HCP_ERROR_VOLTAGE_F_LOW,								// 157
HCP_ERROR_VOLTAGE_G_LOW,								// 158							
														
HCP_ERROR_VOLTAGE_1_HIGH,								// 159
HCP_ERROR_VOLTAGE_2_HIGH,								// 160
HCP_ERROR_VOLTAGE_3_HIGH,								// 161
HCP_ERROR_VOLTAGE_4_HIGH,								// 162
HCP_ERROR_VOLTAGE_5_HIGH,								// 163
HCP_ERROR_VOLTAGE_6_HIGH,								// 164
HCP_ERROR_VOLTAGE_7_HIGH,								// 165
HCP_ERROR_VOLTAGE_8_HIGH,								// 166
HCP_ERROR_VOLTAGE_9_HIGH,								// 167
HCP_ERROR_VOLTAGE_A_HIGH,								// 168
HCP_ERROR_VOLTAGE_B_HIGH,								// 169
HCP_ERROR_VOLTAGE_C_HIGH,								// 170
HCP_ERROR_VOLTAGE_D_HIGH,								// 171
HCP_ERROR_VOLTAGE_E_HIGH,								// 172
HCP_ERROR_VOLTAGE_F_HIGH,								// 173
HCP_ERROR_VOLTAGE_G_HIGH,								// 174

HCP_DEVICE_BUSY,										// 175
HCP_REC_CANCEL_FAILED,									// 176
HCP_DEFECT_FILE_UUID_MISMATCH,							// 177
...
static const char *HcpErrStrList[] = {
	...
	// mammo changes; diagInfo changes;
	"Digital Board (Components) temperature too high (Temperature 1)",	// 135
	"Digital Board (Glass) temperature too high      (Temperature 2)",	// 136
	"Digital Board (Components) temperature too high (Temperature 3)",	// 137
	"Digital Board (Components) temperature too high (Temperature 4)",	// 138
	"Snap on Board (Components) temperature too high (Temperature 5)",	// 139
	"Snap on Board (Components) temperature too high (Temperature 6)",	// 140
	"Unused temperature is too high",									// 141
	"Unused temperature is too high",									// 142

	"Voltage source 22V (Power Supply) is low",							// 143
	"Voltage source AVGL(Config File) is low",							// 144
	"Voltage source VEE	(Power Supply) is low",							// 145
	"Voltage source M4V (Power Supply) is low",							// 146
	"Voltage source VCC3(Power Supply) is low",							// 147
	"Voltage source VCC2.5 (Power Supply) is low",						// 148
	"Voltage source VCC1.2 (Power Supply) is low",						// 149
	"Voltage source AVGH (Config File) is low",							// 150
	"Voltage source p5.5d_v (Power Supply) is low",						// 151
	"Voltage source p5.5a_v (Power Supply) is low",						// 152
	"Voltage source VDD (Power Supply) is low",							// 153
	"Voltage source 28V (Power Supply) is low",							// 154
	"Voltage source unused low",										// 155
	"Voltage source unused low",										// 156
	"Voltage source unused low",										// 157
	"Voltage source unused low",										// 158

	"Voltage source 22V (Power Supply) is high",						// 159
	"Voltage source AVGL (Config File) is high",						// 160
	"Voltage source VEE (Power Supply) is high",						// 161
	"Voltage source M4V (Power Supply) is high",						// 162
	"Voltage source VCC3 (Power Supply) is high",						// 163
	"Voltage source VCC2.5 (Power Supply) is high",						// 164
	"Voltage source VCC1.2 (Power Supply) is high",						// 165
	"Voltage source AVGH is (Config File) high",						// 166
	"Voltage source p5.5d_v (Power Supply) is high",					// 167
	"Voltage source p5.5a_v (Power Supply) is high",					// 168
	"Voltage source VDD (Power Supply) is high",						// 169
	"Voltage source 28V (Power Supply) is high",						// 170
	"Voltage source unused high",										// 171
	"Voltage source unused high",										// 172
	"Voltage source unused high",										// 173
	"Voltage source unused high",										// 174
	"Device is busy",													// 175
	"Cancel Failed",													// 176
	"Defect file UUID mismatch",										// 177
...
// Use to enable and disabling framesumming while acquisition is in progress
